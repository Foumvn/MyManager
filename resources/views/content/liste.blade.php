  ...
  @endif
    ...
    <table class="table table-hover">
      ...
      <tbody class="table-border-bottom-0">
        ...
        <tr>
          <td><i class="fab fa-bootstrap fa-lg text-primary me-3"></i> <strong>{{$clients->nom}}</strong></td>
          <td>{{$clients->project}}</td>
          <td>
          ...
          <td><span class="badge bg-label-warning me-1">{{$clients->numero}}</span></td>
          <td>
            <div class="dropdown">
              <button type="button" class="btn p-0 dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i class="bx bx-dots-vertical-rounded"></i></button>
              <div class="dropdown-menu">
                <a class="dropdown-item" href="javascript:void(0);"><i class="bx bx-edit-alt me-1"></i> Edit</a>
                <a class="dropdown-item" href="/SupClient/{{$clients->id}} "><i class="bx bx-trash me-1"></i> Delete</a>
              </div>
            </div>
          </td>
        </tr>
